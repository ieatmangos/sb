...
const FeaturesV1 = () => {
  return (
    <div className="hds-section__v-spacing hds-section__h-spacing max-w-5xl mx-auto bg-white grid grid-cols-2 gap-4 font-sans">
      <div className="hds-title__large max-w-sm col-span-2 md:col-span-1 mb-xl sm:mb-0 font-black text-primary">
      ...
      <div className="max-w-sm px-xs row-start-2 md:row-start-1 col-span-2 sm:col-span-1 col-start-1 sm:col-start-2 text-primary">        
        <svg
          className="block pb-sm mt-xs w-12"
          width="56"
          height="56"
          viewBox="0 0 56 56"
          fill="none"
        ...
        <p className="pb-sm hds-copy ">Since wire-frame renderings</p>
        <p className="hds-legal">
